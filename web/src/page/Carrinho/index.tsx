              ...
              <div className="container mx-auto mt-10">
                    <div className="flex shadow-md my-10">
                        <div className="w-3/4 bg-white px-10 py-10">
                            ...
                            <h3 className="font-semibold text-gray-600 text-xs uppercase w-2/5">Detalhe do produto</h3>
                            ...
                            <span className="text-center w-1/5 font-semibold text-sm">R$400.00</span>
                            <span className="text-center w-1/5 font-semibold text-sm">R$400.00</span>
                            </div>
                            ...
                            <span className="text-center w-1/5 font-semibold text-sm">R$40.00</span>
                            <span className="text-center w-1/5 font-semibold text-sm">R$40.00</span>
                            </div>
                            ...
                            <span className="text-center w-1/5 font-semibold text-sm">R$150.00</span>
                            <span className="text-center w-1/5 font-semibold text-sm">R$150.00</span>
                            </div>
                        ...
                        <div id="summary" className="w-1/4 px-8 py-10">
                            ...
                            <button className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Confirmar</button>
                            </div>
                        </div>
