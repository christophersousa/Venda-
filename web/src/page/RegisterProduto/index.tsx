...
export function RegisterProduto() {
    ...
    const [categoriasType, setCategoriasType] = useState<CategoriaComTipo[]>([]);
                                ...
                                <div className="">
                                    <div className="">
                                        ...
                                        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label="Default select example">
                                            ...
                                            {categoriasType.map((response, key) =>{
                                            return  <option key={key} value={String(response.name)}>{response.name}</option>
                                        })}
                                        </select>
                                    </div>
                                    </div>
