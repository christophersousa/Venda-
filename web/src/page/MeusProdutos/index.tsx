        ...
        <div>
            <div className=" bg-white m-margin-container w-full p-padding-container">
                ...
                <div className="w-full bg-gray-200 rounded-full">
                    <div className=" bg-background-orange text-xs font-medium text-white text-center p-0.5 leading-none rounded-l-full" style={{width:'25%'}}> 25%</div>
                </div>
            </div>
            ...
            <div className=" flex gap-12 bg-white m-margin-container w-full p-padding-container">
                ...
                <button type="submit" className=" font-bold w-48 justify-center ml-auto inline-flex items-center py-2.5 px-3 text-sm text-white bg-blue-500 border border-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 rounded-lg">
                    <svg aria-hidden="true" className="mr-2 -ml-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>Filtrar
                </button>
            </div>
